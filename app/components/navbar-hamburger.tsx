...
export default function NavHamburger() {
    ...
    return (
        <div>
            ...
            <div className={`absolute border-l-2 border-black/20 p-10 top-20 drop-shadow-md right-0 w-fit flex flex-col gap-4  h-screen bg-rrwhite ${isOpen ? "visible" : "hidden" }`}>
