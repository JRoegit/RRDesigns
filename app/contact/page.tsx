            ...
            <div className="w-full md:w-1/2 max-w-md mx-auto p-6">
                <div className="flex flex-col w-full border-2 border-rrteal rounded-t-md border-b-0 z-20 bg-rrwhite">
                    ...
                    <form className="mx-6 flex flex-col font-semibold gap-2 mb-14">
                        ...
                        <button className="flex flex-row mt-4 font-semibold text-white px-4 py-2 rounded-md bg-amber-500 border-b-3 border-l-3 border-black/40 mx-auto hover:bg-amber-600 hover:cursor-pointer transition-colors duration-250 ease-in-out z-40">Send <FaRegPaperPlane className="ml-2 my-auto text-white"/></button>
                    </form>
                </div>
